/*
 * dailyRotateFile.js: Transport for outputting to a local log file
 *
...
DailyRotateFile.prototype.query = function (options, callback) {
  ...
  var file = path.join(this.dirname, this.filename + this.getFormattedDate()),
